          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" id="nuevaIglesiaUsuario" name="nuevaIglesiaUsuario" required>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <!-- ENTRADA PARA SELECCIONAR SU IGLEISA -->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="editarIglesia" required>
                  <option value="" id="editarIglesia"></option> 
                  <option value="">Seleccione Iglesia</option>
